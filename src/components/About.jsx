    ...
    <Tilt className="xs:w-[250px]  w-full">
      <div className="w-full green-pink-gradient p-[1px] rounded-[20px]">
        <div
          ...
          className="bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly ietms-center flex-col"
        >
          <img
            src={icon}
            alt={title}
            className="w-16 h-16 object-contain justify-content text-center align-center m-auto"
          ></img>
